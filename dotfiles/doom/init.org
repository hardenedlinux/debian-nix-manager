#+TITLE: Hardenedlinux Nix's Doom Emacs config
...
#+RESULTS:
| company-lsp | company-files | company-yasnippet | :separate | company-tabnine |
...
(use-package! org-starter
  ...
  :config
  (org-starter-def "~/.config/nixpkgs/misc/agenda"
                   :files
